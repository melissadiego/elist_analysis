...
| Step ID | Analyst | Data / Column | Action Taken | Logic / Reason | # Affected Rows | Before vs. After Example |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
| **LOG-04** | M.Diego | `USER_ID` column header | Formatting | Freeze 1st column / Bold for readability when scrolling down | 1 | `USER_ID` → **`USER_ID`** |
| **LOG-05** | M.Diego | `orders_data_raw` / PRODUCT_ID | Alignment | Left align (Not a quantitative measure) | 101,129 | N/A |
...
| **LOG-08** | M.Diego | `orders_data_raw` / LOYALTY_PROGRAM | Alignment | Center align for readability | 101,129 | N/A |
| **LOG-09** | M.Diego | `orders_data_raw` / COUNTRY_CODE | Alignment | Center align for readability | 101,129 | N/A |
